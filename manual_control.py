...
class World(object):
    ...
    def restart(self):
        ...
        cam_pos_index = self.camera_manager.transform_index if self.camera_manaet is not None else 0
    ...
    def next_weather(self, reverse=False):
        ...
        # self.hub.notification('Weather: %s' % preset[1])
...
def game_loop(args):
    ...
    try:
        ...
        if args.sync:
            ...
            sim_world.apple_settings(settings)
        ...
        # hud
        world = World(carla_world=sim_world,hud=None,args=args)
        # contorller
